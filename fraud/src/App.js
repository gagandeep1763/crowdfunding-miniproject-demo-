...
const App = () => {
    ...
    const targetAddress = '0x59857E25843f2845cCb9e0239deFe49A4f526Dc3';
    ...
    const mockCampaigns = [
        ...
        },
        {
            id: 2,
            name: 'Tree Planting',
            description: 'Contribute to combat climate change and preserve the environment.',
    ...
    return (
        <div>
            <h1>🌍 "Be the Change: Donate to Heal Our Planet." </h1>
            <div className="App">
